...
(function(){
    ...
    test("EventEmitter", function(){
        expect(2);
        var emitter = new sclient.EventEmitter();
    ...
    test("EventEmitter property sharing", function(){
        expect(2);
        var emitter1 = new sclient.EventEmitter();
        emitter1.on("event", function(origin, args){
            ok(args === "first");
        });
        var emitter2 = new sclient.EventEmitter();
    ...
    test("ObservableProperty", function(){
        expect(2);
        var prop1 = new sclient.ObservableProperty(1);
        prop1.notify(function(){
            ok(true, "first changed");
        });
        var prop2 = new sclient.ObservableProperty(2);
    ...
    test("ObservableCollection", function(){
       expect(6);
       var collection = new sclient.ObservableCollection();
